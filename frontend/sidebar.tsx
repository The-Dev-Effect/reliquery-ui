...
import { FiHome, FiMenu, FiDatabase, FiType, FiBox } from "react-icons/fi";
...
const MobileNav = ({ onOpen, onRefreshed, ...rest }: MobileProps) => {
  ...
  const toastSuccess = async () => {
    ...
    const result = await fetch(`${base_path}/api/sync_reliquery`);
  ...
  return (
    ...
    >
      ...
      <HStack spacing={{ base: "0", md: "6" }}>
        <Button bg="orange.200" onClick={toastSuccess}>
          Sync Reliquery
        </Button>
      </HStack>
    </Flex>
